...
build: pg_query/c_bridge.o pg_query/protobuf_bridge.o libpg_query/libpg_query.a
...
pg_query/protobuf_bridge.o: pg_query/protobuf_bridge.c pg_query/protobuf_bridge.h libpg_query/pg_query.h
...
clean:
	rm -f pg_query/c_bridge.o pg_query/protobuf_bridge.o
